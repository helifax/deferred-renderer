...
enum LIGHTMODES
  {
  DIRECTIONALLIGHT =0, /// @brief directional light from old OPenGL
  POINTLIGHT = 1,  /// @brief point light
  SPOTLIGHT = 2
  };
...
public:
  ...
  /// @param[in] _stream the xml stream to write to
  /// @param[in] _name an overidable token name for the xml tag
  //----------------------------------------------------------------------------------------------------------------------
	void writeXML(
									QXmlStreamWriter* _stream,
                  const std::string _tag="Light"
								) const;
  //----------------------------------------------------------------------------------------------------------------------
